...
func (scu *SubCategoryUpdate) SetNillableDescription(s *string) *SubCategoryUpdate {
	if s != nil {
...
func (scu *SubCategoryUpdate) ClearDescription() *SubCategoryUpdate {
...
func (scu *SubCategoryUpdate) check() error {
	...
	if scu.mutation.CategoryCleared() && len(scu.mutation.CategoryIDs()) > 0 {
...
func (scu *SubCategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if scu.mutation.DescriptionCleared() {
		_spec.ClearField(subcategory.FieldDescription, field.TypeString)
	}
...
// SetNillableDescription sets the "description" field if the given value is not nil.
func (scuo *SubCategoryUpdateOne) SetNillableDescription(s *string) *SubCategoryUpdateOne {
	if s != nil {
...
// ClearDescription clears the value of the "description" field.
func (scuo *SubCategoryUpdateOne) ClearDescription() *SubCategoryUpdateOne {
...
func (scuo *SubCategoryUpdateOne) check() error {
	...
	if scuo.mutation.CategoryCleared() && len(scuo.mutation.CategoryIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "SubCategory.category"`)
	}
	return nil
}
